...
import type { ID, PageQuery, PageResult, PolicyArticle, PolicyCrawlTask, PolicyPreflightResult, PolicySource, PolicySourceForm } from './types';
...
export function preflightPolicySource(data: { projectId: ID; sourceId?: ID; url: string }) { return request.post<PolicyPreflightResult>('/policy/sources/preflight', data); }
