...
grep -q 'libgl1' "$repo_root/deploy/Dockerfile.python-ai-service" || fail 'Python AI container must install libgl1 for the Paddle OCR runtime.'
grep -q 'libglib2.0-0' "$repo_root/deploy/Dockerfile.python-ai-service" || fail 'Python AI container must install libglib2.0-0 for the Paddle OCR runtime.'
