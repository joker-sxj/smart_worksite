...
public class FileParseWorker {
    ...
    private String buildMetadata(ParsedDocument parsedDocument, PreparedDocument preparedDocument,
        ...
        metadata.put("detectedFormat", preparedDocument.getDetectedFormat());
        metadata.put("effectiveFormat", preparedDocument.getInputFormat());
        metadata.put("formatDetectionSource", preparedDocument.getFormatDetectionSource());
